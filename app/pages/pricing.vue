...
<template>
  <section class="bg-brand-cream py-24 min-h-[80vh] flex flex-col items-center justify-center">
    <div class="max-w-7xl mx-auto px-6 md:px-8 w-full">
      
      <!-- Header -->
      <div class="text-center max-w-2xl mx-auto mb-16">
        <p class="text-sm font-semibold text-brand-green-700 tracking-[0.08em] uppercase mb-4">Pricing for Lawyers</p>
        <h1 class="font-heading font-medium text-brand-green-900 leading-[1.05] tracking-[-0.02em] mb-6" style="font-size:clamp(36px,4.5vw,56px);">
      ...
      <div class="max-w-lg mx-auto bg-white rounded-3xl border border-brand-line p-10 shadow-[0_12px_40px_-12px_rgba(15,46,26,0.15)] relative overflow-hidden">
        ...
        <div class="text-center mb-8 mt-2">
          <h2 class="text-5 font-semibold text-brand-green-900 mb-3">Annual Subscription</h2>
        ...
        <!-- Features list -->
        <div>
          <p class="text-3 font-semibold text-brand-ink-soft uppercase tracking-[0.05em] mb-4">Everything included:</p>
          <ul class="list-none p-0 m-0 space-y-3.5">
            <li v-for="feat in features" :key="feat" class="flex items-start gap-3 text-4 text-brand-ink font-medium">
              <div class="w-5 h-5 rounded-full bg-brand-green-100 flex items-center justify-center text-brand-green-700 shrink-0 mt-0.5">
