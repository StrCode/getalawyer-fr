  ...
  <div class="space-y-12 pb-20">
    ...
    <div v-else class="space-y-12">
      ...
      <div class="space-y-10">
        <div class="form-row">
          <label class="etsy-label">National Identity Number <span class="text-primary">*</span></label>
        ...
        <div class="form-row">
          <label class="etsy-label">Verification Consent <span class="text-primary">*</span></label>
