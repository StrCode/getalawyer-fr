...
<template>
  <div class="text-center py-12">
    <!-- Header Section -->
    <div class="mb-12">
      <div class="mx-auto mb-8 flex size-20 items-center justify-center rounded-full border-4 border-background bg-warning/10 text-warning shadow-lg relative">
    ...
    <div v-else class="space-y-12">
      ...
      <div class="rounded-2xl border border-border bg-card p-8 text-left shadow-sm transition-all hover:shadow-md">
       <h2 class="mb-4 flex items-center gap-3 text-lg font-medium text-foreground">
        ...
        <div class="space-y-4">
          <div v-if="rejectionReason" class="rounded-xl border border-warning/30 bg-warning/10 p-6">
