          ...
          <div class="p-4 rounded-3xl bg-white border border-brand-line shadow-sm">
            <div class="rounded-3xl overflow-hidden mb-6 h-[240px] bg-brand-line/30 relative">
              <iframe 
                ...
                class="absolute inset-0 grayscale contrast-[1.1] opacity-90"
              ></iframe>
            </div>
            <div class="px-4 pb-4">
          ...
          <form @submit.prevent="handleSubmit" class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2.5">
              ...
              <div class="relative">
                ...
                <PhIcon name="ph:caret-down" class="w-5 h-5 text-brand-ink-soft absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none" />
              </div>
            </div>
