    ...
    >
      ...
      <div class="relative z-10 mx-auto max-w-md">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-3">
          <button
            type="button"
            class="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 font-sans text-sm font-semibold text-sidebar-foreground transition-colors hover:bg-sidebar"
            @click="clearAndGo('/')"
          >
            Go home
          </button>
          <button
            type="button"
            class="inline-flex items-center justify-center rounded-full border border-border bg-white px-6 py-3 font-sans text-sm font-medium text-foreground transition-colors hover:bg-card"
            @click="clearError()"
          >
            Try again
          </button>
