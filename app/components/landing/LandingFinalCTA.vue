...
<template>
  <section class="bg-brand-cream py-32">
    <div class="max-w-7xl mx-auto px-6 md:px-8">
      ...
      <!-- Split Card CTA -->
      <div class="bg-brand-green-900 rounded-3xl overflow-hidden flex flex-col lg:flex-row relative shadow-[0_24px_64px_-16px_rgba(15,46,26,0.15)]">
        
        <!-- Text Side -->
        <div class="flex-1 p-12 lg:p-20 flex flex-col justify-center relative z-10">
          <p class="text-sm font-semibold text-brand-green-300 tracking-[0.08em] uppercase mb-4">Ready when you are</p>
