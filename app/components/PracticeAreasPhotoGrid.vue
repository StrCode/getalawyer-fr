...
<template>
  <div class="grid grid-cols-2 gap-4 sm:gap-5 lg:grid-cols-4" role="list">
    <motion.button
      ...
      class="group relative aspect-4/3 w-full overflow-hidden rounded-[10px] text-left shadow-sm shadow-black/10 outline-none ring-offset-2 transition-shadow hover:shadow-md focus-visible:ring-2 focus-visible:ring-brand/60 dark:shadow-black/25 dark:hover:shadow-lg"
